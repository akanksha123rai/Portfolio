    ...
    <motion.div id='about' className='w-full px-[12%] py-10 scroll-mt-20'
      ...
      <motion.div
        ...
        <motion.div
          ...
          className='flex-1'>
          <p className='mb-10 max-w-2xl font-Ovl'> I have completed my Bachelor’s degree in Computer Science from Bajaj Institute of Technology.
            ...
            I possess strong problem-solving skills and can identify solutions for complex engineering challenges.</p>
